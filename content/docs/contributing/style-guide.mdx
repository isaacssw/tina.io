...
This document should be used as a guideline when writing documentation and blog posts on [tina.io](http://tina.io "tina.io")
...
* Avoid using `code tags` in [links](https://tina.io).
* [Links](https://tina.io) should stand out *consistently* from their surrounding text; avoid applying additional formatting. *[Links](https://tina.io) appearing within emphasized text* may be **[formatted](https://tina.io)** **appropriately**.
* Link text should flow naturally in prose and relate semantically to the link target. Basically, just don't use "[click here](https://tina.io)".
